    ...
    const theme = createTheme(
        {
            ...
            palette: {
                ...
                // Cor do box onde fica (Abertas / Resolvidas)
                    tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                
                // Cor da parte (novo | Todos | Filas)
                ...
                // 
                    fontecor: mode === "light" ? "#00BFFF !important" : "#fff",
                ...
                // 
                    barraSuperior: mode === "light" ? "linear-gradient(to right, #00BFFF, #0074ff, #001276)" : "#666",
